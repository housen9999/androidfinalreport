...
public class Clik2Activity extends KWBaseSceneActivity {
    int money=30;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_clik2);
    }
    ...
    protected void onOptionSelected (String identifier, int index){
        ...
        if ("場景2選項".equals(identifier)) {
            if (index == 0) {
                money=money+25;
                switchSceneActivity(MyScene6Activity.class, false);
            }
            else if (index == 1) {
                money = money + 15;
                switchSceneActivity(MyScene7Activity.class, false);
            }
