...
public class MyScene7Activity extends KWBaseSceneActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_scene7);
    }
    @Override
    protected void initializeEvent () {
        ...
        KWThirdPersonEventModel event2 = new KWThirdPersonEventModel(character2, "還剩30元，買一下好了").setBackgroundDrawable(background);
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        switchSceneActivity(Clik5Activity.class, false);
