...
public class MyScene4Activity extends KWBaseSceneActivity {
    ...
    protected void initializeEvent () {
        ...
        KWThirdPersonEventModel event1 = new KWThirdPersonEventModel(character1, "還剩45元，吃完配個甜甜的東西吃好了").setBackgroundDrawable(background);
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        switchSceneActivity(Clik2Activity.class, false);
