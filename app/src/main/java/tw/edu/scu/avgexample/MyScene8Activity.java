...
public class MyScene8Activity extends KWBaseSceneActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_scene8);
    }
    @Override
    protected void initializeEvent () {
        ...
        KWThirdPersonEventModel event2 = new KWThirdPersonEventModel(character2, "還剩25元，買一下好了").setBackgroundDrawable(background);
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        switchSceneActivity(Clik6Activity.class, false);
