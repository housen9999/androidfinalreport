...
public class MyScene6Activity extends KWBaseSceneActivity {
    int money=55;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_scene6);
    }
    @Override
    protected void initializeEvent () {
        ...
        KWThirdPersonEventModel event2 = new KWThirdPersonEventModel(character2, "還剩20元，買一下好了").setBackgroundDrawable(background);
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        switchSceneActivity(Clik4Activity.class, false);
